<section class="events-events has-background-color-and-both-waves">
    <h2 style="font-size: 58px; margin-top: 50px;">Events</h2>
        ...
        if ($query->have_posts()) :
            while ($query->have_posts()) : $query->the_post(); ?>
                ...
                <div class="highlighted-event-card">
                    <!-- <div class="highlighted-event-card-image" style="background-image: url(<?php the_field('webinars_image'); ?>);"> -->
...
<div style="margin-top: 50px; margin-bottom: 50px;">
    <a style="background: #EBBA16; color: white; padding: 15px 40px 15px 40px; border-radius: 5px;" id="load-more-events">
        View All
    </a>
</div>
</section>